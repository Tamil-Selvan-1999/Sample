...
class EnablerService {
    ...
    public function isEnabled(Node &$node) {
        ...
        try {
            ...
            \Drupal::messenger()->addError(t('Unable to determine RSVP settings st this time. Please try again.'));
            return NULL;
        }
    }

    /**
     * Sets an individual node to the RSVP enabled.
     * 
     * @param Node $node
     * @throws Exception
     */
    ...
    public function delEnabled(Node $node) {
        try {
            ...
            \Drupal::messenger()->addError(t('Unable to sae RSVP settings at this time. Please try again.'));
        }
    }
}